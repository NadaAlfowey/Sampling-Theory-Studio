...
def getMaxFreq():
    ...
    # Converts the index of the maximum frequency component to a frequency value by multiplying it by the frequency resolution 
    # which is the sampling frequency divided by the number of frequency bins in the FFT result.
